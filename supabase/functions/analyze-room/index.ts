...
serve(async (req) => {
  ...
  try {
    ...
    // fresh server-side client never has — this always rejected valid
    // tokens too (same bug fixed in create-razorpay-order,
    // verify-razorpay-payment, delete-account). Pass the token explicitly.
